...
namespace LoginApp {
    ...
    public partial class LoginAppDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            private global::System.Data.DataColumn columnProductIsBlocked;
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public global::System.Data.DataColumn ProductIsBlockedColumn {
                get {
                    return this.columnProductIsBlocked;
                }
            }
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ProductsRow AddProductsRow(string ProductName, string ProductDescription, double ProductPrice, int ProductStock, bool ProductIsBlocked, int UserID) {
            ...
            internal void InitVars() {
                ...
                this.columnProductIsBlocked = base.Columns["ProductIsBlocked"];
            ...
            private void InitClass() {
                ...
                this.columnProductIsBlocked = new global::System.Data.DataColumn("ProductIsBlocked", typeof(bool), null, global::System.Data.MappingType.Element);
                base.Columns.Add(this.columnProductIsBlocked);
                ...
                this.columnProductIsBlocked.AllowDBNull = false;
        ...
        public partial class ProductsRow : global::System.Data.DataRow {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public bool ProductIsBlocked {
                get {
                    return ((bool)(this[this.tableProducts.ProductIsBlockedColumn]));
                }
                set {
                    this[this.tableProducts.ProductIsBlockedColumn] = value;
                }
            }
...
namespace LoginApp.LoginAppDataSetTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            tableMapping.ColumnMappings.Add("ProductIsBlocked", "ProductIsBlocked");
            tableMapping.ColumnMappings.Add("UserID", "UserID");
            this._adapter.TableMappings.Add(tableMapping);
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [LoginApp].[Products] WHERE (([ProductID] = @Original_ProductID) AND ([ProductName] = @Original_ProductName) AND ([ProductDescription] = @Original_ProductDescription) AND ([ProductPrice] = @Original_ProductPrice) AND ([ProductStock] = @Original_ProductStock) AND ([ProductIsBlocked] = @Original_ProductIsBlocked) AND ([UserID] = @Original_UserID))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_ProductIsBlocked", global::System.Data.SqlDbType.Bit, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ProductIsBlocked", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_UserID", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "UserID", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [LoginApp].[Products] ([ProductName], [ProductDescription], [ProductPrice], [ProductStock], [ProductIsBlocked], [UserID]) VALUES (@ProductName, @ProductDescription, @ProductPrice, @ProductStock, @ProductIsBlocked, @UserID);
SELECT ProductID, ProductName, ProductDescription, ProductPrice, ProductStock, ProductIsBlocked, UserID FROM LoginApp.Products WHERE (ProductID = SCOPE_IDENTITY())";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ProductIsBlocked", global::System.Data.SqlDbType.Bit, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ProductIsBlocked", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@UserID", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "UserID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [LoginApp].[Products] SET [ProductName] = @ProductName, [ProductDescription] = @ProductDescription, [ProductPrice] = @ProductPrice, [ProductStock] = @ProductStock, [ProductIsBlocked] = @ProductIsBlocked, [UserID] = @UserID WHERE (([ProductID] = @Original_ProductID) AND ([ProductName] = @Original_ProductName) AND ([ProductDescription] = @Original_ProductDescription) AND ([ProductPrice] = @Original_ProductPrice) AND ([ProductStock] = @Original_ProductStock) AND ([ProductIsBlocked] = @Original_ProductIsBlocked) AND ([UserID] = @Original_UserID));
SELECT ProductID, ProductName, ProductDescription, ProductPrice, ProductStock, ProductIsBlocked, UserID FROM LoginApp.Products WHERE (ProductID = @ProductID)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ProductIsBlocked", global::System.Data.SqlDbType.Bit, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ProductIsBlocked", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_ProductIsBlocked", global::System.Data.SqlDbType.Bit, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ProductIsBlocked", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ProductID, ProductName, ProductDescription, ProductPrice, ProductStock, Pr" +
                "oductIsBlocked, UserID FROM LoginApp.Products";
        ...
        public virtual int Fill(LoginAppDataSet.ProductsDataTable dataTable) {
        ...
        public virtual LoginAppDataSet.ProductsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LoginAppDataSet.ProductsDataTable dataTable = new LoginAppDataSet.ProductsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LoginAppDataSet.ProductsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ProductID, string Original_ProductName, string Original_ProductDescription, double Original_ProductPrice, int Original_ProductStock, bool Original_ProductIsBlocked, int Original_UserID) {
            ...
            this.Adapter.DeleteCommand.Parameters[4].Value = ((int)(Original_ProductStock));
            this.Adapter.DeleteCommand.Parameters[5].Value = ((bool)(Original_ProductIsBlocked));
        ...
        public virtual int Insert(string ProductName, string ProductDescription, double ProductPrice, int ProductStock, bool ProductIsBlocked, int UserID) {
            if ((ProductName == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[3].Value = ((int)(ProductStock));
            this.Adapter.InsertCommand.Parameters[4].Value = ((bool)(ProductIsBlocked));
        ...
        public virtual int Update(string ProductName, string ProductDescription, double ProductPrice, int ProductStock, bool ProductIsBlocked, int UserID, int Original_ProductID, string Original_ProductName, string Original_ProductDescription, double Original_ProductPrice, int Original_ProductStock, bool Original_ProductIsBlocked, int Original_UserID, int ProductID) {
            if ((ProductName == null)) {
                throw new global::System.ArgumentNullException("ProductName");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(ProductStock));
            this.Adapter.UpdateCommand.Parameters[4].Value = ((bool)(ProductIsBlocked));
            ...
            this.Adapter.UpdateCommand.Parameters[10].Value = ((int)(Original_ProductStock));
            this.Adapter.UpdateCommand.Parameters[11].Value = ((bool)(Original_ProductIsBlocked));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ProductName, string ProductDescription, double ProductPrice, int ProductStock, bool ProductIsBlocked, int UserID, int Original_ProductID, string Original_ProductName, string Original_ProductDescription, double Original_ProductPrice, int Original_ProductStock, bool Original_ProductIsBlocked, int Original_UserID) {
            return this.Update(ProductName, ProductDescription, ProductPrice, ProductStock, ProductIsBlocked, UserID, Original_ProductID, Original_ProductName, Original_ProductDescription, Original_ProductPrice, Original_ProductStock, Original_ProductIsBlocked, Original_UserID, Original_ProductID);
        }
    }
