...
namespace LoginApp.SalesDataSetTableAdapters {
...
SELECT CustomerID, OrderID, OrderDate, FilledDate, Status, Amount FROM Sales.Orders WHERE (OrderID = @OrderID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=(localdb)\\mssqllocaldb;Initial Catalog=Sales;Integrated Security=True" +
                ";Pooling=False";
        }
